...
const ForProviders = () => {
  ...
  return (
    <section id="providers" className="py-24 bg-slate-900 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <FadeIn direction="right">
            <span className="inline-block px-4 py-1.5 rounded-full bg-white/10 text-emerald-400 text-sm font-semibold mb-6 border border-white/10">
            ...
            <a href="#contact" className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-500 text-white rounded-full font-semibold text-lg hover:bg-emerald-600 transition-all hover:scale-105 shadow-xl shadow-emerald-500/25">
              Become a Service Provider <ArrowRight size={20} />
            </a>
          </FadeIn>
            ...
            <div className="relative">
              <div className="bg-slate-800 rounded-3xl p-6 shadow-2xl border border-slate-700">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-white font-bold text-lg">Provider Dashboard</h3>
                    <p className="text-slate-400 text-sm">Welcome back, Thabo</p>
                  </div>
                ...
                <div className="space-y-3">
                  <p className="text-sm text-slate-400 font-medium">Recent Tasks</p>
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-slate-700/30 rounded-xl p-3">
                      ...
                      <span className="text-white font-semibold">{task.amount}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 bg-emerald-500 text-white rounded-2xl p-4 shadow-xl"
              >
                <div className="flex items-center gap-2">
                  <TrendingUp size={20} />
                  <div>
                    <p className="text-xs text-emerald-100">This Month</p>
                    <p className="font-bold">+24% Growth</p>
                  </div>
                </div>
              </motion.div>
            </div>
